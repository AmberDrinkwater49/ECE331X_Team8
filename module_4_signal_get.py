...
Fc = (int)(914.9e6) #carrier frequency - original: 433.9e6

bandwidth = 2e6 #Bandwidth of front-end analog filter of RX path original: 10e5
...
def main():
    ...
    plt.savefig('plotBLE.png')
    #plt.show()
    print("image made")

    np.save('samplesBLE', final_data)
    samples = np.load('samplesBLE.npy')
    print(samples)
